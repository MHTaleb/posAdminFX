...
public class PackServerResponse implements Serializable
{

@JsonProperty("message")
private String message;
@JsonProperty("content")
private List<PackContent> content = null;
...
* @param sequence
*/
public PackServerResponse(String message, List<PackContent> content, Object sequence) {
super();
...
public PackServerResponse withMessage(String message) {
this.message = message;
return this;
}
...
@JsonProperty("content")
public void setPackContent(List<PackContent> content) {
this.content = content;
}

public PackServerResponse withPackContent(List<PackContent> content) {
this.content = content;
return this;
}
...
public PackServerResponse withSequence(Object sequence) {
this.sequence = sequence;
return this;
}
...
public PackServerResponse withAdditionalProperty(String name, Object value) {
this.additionalProperties.put(name, value);
return this;
}
...
if ((other instanceof PackServerResponse) == false) {
return false;
}
PackServerResponse rhs = ((PackServerResponse) other);
