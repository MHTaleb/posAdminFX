...
public class OneComponentServerResponse implements Serializable
{
...
* 
*/
public OneComponentServerResponse() {
}
...
* @param sequence
*/
public OneComponentServerResponse(String message, ComponentContent content, Object sequence) {
super();
...
public OneComponentServerResponse withMessage(String message) {
this.message = message;
return this;
}
...
public OneComponentServerResponse withContent(ComponentContent content) {
this.content = content;
return this;
}
...
public OneComponentServerResponse withSequence(Object sequence) {
this.sequence = sequence;
return this;
}
...
public OneComponentServerResponse withAdditionalProperty(String name, Object value) {
this.additionalProperties.put(name, value);
return this;
}
...
OneComponentServerResponse rhs = ((OneComponentServerResponse) other);
