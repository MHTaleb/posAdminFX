...
public class ADServerAddAnswer implements Serializable
{
...
* @param sequence
*/
public ADServerAddAnswer(String message, List<Long> content, Object sequence) {
super();
...
public ADServerAddAnswer withMessage(String message) {
this.message = message;
return this;
}
...
public ADServerAddAnswer withContent(List<Long> content) {
this.content = content;
return this;
}
...
public ADServerAddAnswer withSequence(Object sequence) {
this.sequence = sequence;
return this;
}
...
public ADServerAddAnswer withAdditionalProperty(String name, Object value) {
this.additionalProperties.put(name, value);
return this;
}
...
if ((other instanceof ADServerAddAnswer) == false) {
return false;
}
ADServerAddAnswer rhs = ((ADServerAddAnswer) other);
