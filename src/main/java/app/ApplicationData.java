...
public class ApplicationData implements Serializable {
     ...
     * @param cmpAttrLabel
     */
    public ApplicationData(long id, String cmpAttrLabel, String cmpAttrValue, String cmpAttrCode) {
        super();
        this.id = id;
    ...
    public ApplicationData withId(long id) {
        this.id = id;
        return this;
    }
    ...
    public ApplicationData withCmpAttrLabel(String cmpAttrLabel) {
        this.cmpAttrLabel = cmpAttrLabel;
        return this;
    }
    ...
    public ApplicationData withCmpAttrValue(String cmpAttrValue) {
        this.cmpAttrValue = cmpAttrValue;
        return this;
    }
    ...
    public ApplicationData withCmpAttrCode(String cmpAttrCode) {
        this.cmpAttrCode = cmpAttrCode;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ApplicationData) == false) {
            return false;
        }
        ApplicationData rhs = ((ApplicationData) other);
