...
public class ComponentDataTDO {
    ...
    public ComponentDataTDO() {
    }
    
    public ComponentDataTDO withCode(String code){
        this.setAttCode(code);
        return this;
    }
    
    public ComponentDataTDO withTitle(String title){
        this.setAttTitle(title);
        return this;
    }
    
    public ComponentDataTDO withValue(String value){
    ...
    public boolean equals(Object obj) {
        ...
        final ComponentDataTDO other = (ComponentDataTDO) obj;
